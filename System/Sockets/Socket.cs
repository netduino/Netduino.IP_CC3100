    ...
    public class Socket : IDisposable
    {
        ...
        public int Available
        {
            get
            {
                ...
                NativeSocket.ioctl(m_Handle, NativeSocket.FIONREAD, ref cBytes);
        ...
        private EndPoint GetEndPoint(bool fLocal)
        {
            ...
            if (fLocal)
            {
                NativeSocket.getsockname(m_Handle, out address);
            }
            else
            {
                NativeSocket.getpeername(m_Handle, out address);
            }
        ...
        public int ReceiveTimeout
        {
            ...
            set
            {
                ...
                /* NOTE: for CC3100, set SL_SO_RCVTIMEO socket option */
                byte[] timeoutBytes = new byte[4];
                timeoutBytes[0] = (byte)(((value / 1000) >> 0) & 0xFF); // seconds
                timeoutBytes[1] = (byte)(((value / 1000) >> 8) & 0xFF); // seconds
                timeoutBytes[2] = (byte)(((value % 1000) >> 0) & 0xFF); // milliseconds
                timeoutBytes[3] = (byte)(((value % 1000) >> 8) & 0xFF); // milliseconds
                SetSocketOption(SocketOptionLevel.Socket, SocketOptionName.ReceiveTimeout, timeoutBytes);
            }
        }
        ...
        public void Bind(EndPoint localEP)
        {
            ...
            NativeSocket.bind(m_Handle, localEP.Serialize().m_Buffer);
        ...
        public void Connect(EndPoint remoteEP)
        {
            ...
            NativeSocket.connect(m_Handle, remoteEP.Serialize().m_Buffer, !m_fBlocking);
        ...
        public void Listen(int backlog)
        {
            ...
            NativeSocket.listen(m_Handle, backlog);
        }
        ...
        public Socket Accept()
        {
            ...
            socketHandle = NativeSocket.accept(m_Handle);
        ...
        public int Send(byte[] buffer, int offset, int size, SocketFlags socketFlags)
        {
            ...
            return NativeSocket.send(m_Handle, buffer, offset, size, (int)socketFlags, m_sendTimeout);
        }
        ...
        public int SendTo(byte[] buffer, int offset, int size, SocketFlags socketFlags, EndPoint remoteEP)
        {
            ...
            return NativeSocket.sendto(m_Handle, buffer, offset, size, (int)socketFlags, m_sendTimeout, address);
        }
        ...
        public int Receive(byte[] buffer, int offset, int size, SocketFlags socketFlags)
        {
            ...
            return NativeSocket.recv(m_Handle, buffer, offset, size, (int)socketFlags, m_recvTimeout);
        }
        ...
        public int ReceiveFrom(byte[] buffer, int offset, int size, SocketFlags socketFlags, ref EndPoint remoteEP)
        {
            ...
            len = NativeSocket.recvfrom(m_Handle, buffer, offset, size, (int)socketFlags, m_recvTimeout, ref address);
        ...
        public void SetSocketOption(SocketOptionLevel optionLevel, SocketOptionName optionName, int optionValue)
        {
            ...
            NativeSocket.setsockopt(m_Handle, (int)optionLevel, (int)optionName, val);
        }
        ...
        public void SetSocketOption(SocketOptionLevel optionLevel, SocketOptionName optionName, byte[] optionValue)
        {
            ...
            NativeSocket.setsockopt(m_Handle, (int)optionLevel, (int)optionName, optionValue);
        }
        ...
        public void GetSocketOption(SocketOptionLevel optionLevel, SocketOptionName optionName, byte[] val)
        {
            ...
            NativeSocket.getsockopt(m_Handle, (int)optionLevel, (int)optionName, val);
        }
        ...
        public bool Poll(int microSeconds, SelectMode mode)
        {
            ...
            return NativeSocket.poll(m_Handle, (int)mode, microSeconds);
        }
